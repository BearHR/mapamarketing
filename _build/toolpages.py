...
<section class="sec">
  <div class="wrap" style="max-width:900px">
    ...
    <div class="result" id="auditResult" hidden>
      ...
      <a class="btn btn--wa wa" id="auditWA" href="https://wa.me/19805164214"
...
<section class="sec">
  <div class="wrap" style="max-width:760px">
    ...
    <div class="result" id="calcResult" hidden>
      ...
      <a class="btn btn--wa wa" id="calcWA" href="https://wa.me/19805164214"
...
<section class="sec">
  <div class="wrap" style="max-width:800px">
    ...
    <div class="result" id="pResult" hidden>
      ...
      <div id="pOut"></div>
      <a class="btn btn--wa wa" id="pWA" href="https://wa.me/19805164214"
...
<section class="sec">
  <div class="wrap" style="max-width:860px">
    ...
    <a class="btn btn--wa wa" id="citWA" href="https://wa.me/19805164214"
